...
export default function AdminPanel({ token, onVoltar }) {
  ...
  const carregarUsuarios = async () => {
    setCarregando(true);
    try {
      const res = await fetch('http://iptv.tecnopriv.top:8006/api/admin/users', {
  ...
  const handleAdicionarDias = async (userId) => {
    ...
    try {
      const res = await fetch(`http://iptv.tecnopriv.top:8006/api/admin/users/${userId}/premium`, {
        method: 'PUT',
  ...
  const handleToggleStatus = async (userId, statusAtual) => {
    ...
    try {
      const res = await fetch(`http://iptv.tecnopriv.top:8006/api/admin/users/${userId}/status`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json', 'Authorization': `Bearer ${token}` },
  ...
  const handleApagarUsuario = async (userId, username) => {
    ...
    try {
      const res = await fetch(`http://iptv.tecnopriv.top:8006/api/admin/users/${userId}`, {
        method: 'DELETE',
        headers: { 'Authorization': `Bearer ${token}` }
      });
      if (res.ok) {
  ...
  const abrirGerenciadorPlaylists = async (user) => {
    ...
    try {
      const res = await fetch(`http://iptv.tecnopriv.top:8006/api/admin/users/${user.id}/playlists`, {
        headers: { 'Authorization': `Bearer ${token}` }
      });
      const data = await res.json();
  ...
  const deletarPlaylistAdmin = async (playlistId) => {
    ...
    try {
      const res = await fetch(`http://iptv.tecnopriv.top:8006/api/admin/playlists/${playlistId}`, {
        method: 'DELETE',
        headers: { 'Authorization': `Bearer ${token}` }
      });
      if (res.ok) {
  ...
  const salvarEdicaoPlaylist = async (e) => {
    e.preventDefault();
    try {
      const res = await fetch(`http://iptv.tecnopriv.top:8006/api/admin/playlists/${editandoPlaylist.id}`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json', 'Authorization': `Bearer ${token}` },
  ...
  const salvarNovaPlaylist = async (e) => {
    e.preventDefault();
    try {
      const res = await fetch(`http://iptv.tecnopriv.top:8006/api/admin/users/${usuarioSelecionado.id}/playlists`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json', 'Authorization': `Bearer ${token}` },
